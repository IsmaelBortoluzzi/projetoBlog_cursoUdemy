...
class PostIndex(ListView):
    ...
    def get_queryset(self):
        ...
        qs = qs.select_related('categoria_post')  # vai fazer só uma consulta para esta tabela relacionada
...
class PostBusca(PostIndex):
    ...
    def get_queryset(self):
        ...
        )  # categoria_post__nome_cat__iexact: O primeiro é o campo do post. Ele é uma foreign key
        # depois de __ é o campo da foreigm key
        # depois é o metodo de busca
